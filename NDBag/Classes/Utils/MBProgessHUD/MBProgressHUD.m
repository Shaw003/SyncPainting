...
- (void)layoutSubviews {
    ...
    NSDictionary *dic = @{NSFontAttributeName:[UIFont boldSystemFontOfSize:16.f]};
    CGSize labelSize = [label.text sizeWithAttributes:dic];
...
//    if (TARGET_IPHONE_SIMULATOR || CURRENT_DEVICE > 7) {
