...
+ (NSDate *)dateFromResponse:(XMPPIQ *)iq
{
	...
	// However, if you print the value using MYLog via "%@",
	...
	// 
	// MYLog(@"%f", [refDate timeIntervalSinceReferenceDate]);  // Prints: 0.0
	// MYLog(@"%@", refDate);                                   // Prints: 2000-12-31 19:00:00 -05:00
	// MYLog(@"%@", [utcDateFormatter stringFromDate:refDate]); // Prints: 2001-01-01 00:00:00 +00:00
	// 
	...
	// If we printed it out generically using MYLog, then we would see it converted into our local time zone.
