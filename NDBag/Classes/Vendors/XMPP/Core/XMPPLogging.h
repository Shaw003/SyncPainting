 ...
 * 
 * Step 3:
 * Replace your MYLog statements with XMPPLog statements according to the severity of the message.
 * 
 * MYLog(@"Fatal error, no dohickey found!"); -> XMPPLogError(@"Fatal error, no dohickey found!");
 * 
 * XMPPLog has the same syntax as MYLog.
