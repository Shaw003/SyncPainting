 ...
 * the traditional MYLog() function directs it's output to two places:
 * 
 * - Apple System Log (so it shows up in Console.app)
 * - StdErr (if stderr is a TTY, so log statements show up in Xcode console)
 * 
 * To duplicate MYLog() functionality you can simply add this logger and an asl logger.
 ...
 * 
 * This would essentially give you a straight MYLog replacement that prints in purple:
 * 
