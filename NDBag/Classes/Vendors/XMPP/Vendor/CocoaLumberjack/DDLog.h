 ...
 * 
 * Step 3:
 * Replace your MYLog statements with DDLog statements according to the severity of the message.
 * 
 * MYLog(@"Fatal error, no dohickey found!"); -> DDLogError(@"Fatal error, no dohickey found!");
 * 
 * DDLog works exactly the same as MYLog.
 * This means you can pass it multiple variables just like MYLog.
**/
...
/**
 * Returns the threadID as it appears in MYLog.
